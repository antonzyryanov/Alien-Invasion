...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'mainThemeCredit': 'Main theme: YSN (tayson)',
      'levels123Credit': 'Levels 1-3: YSN (tayson)',
      'level4Credit': 'Level 4: slumpy99',
      'level5Credit': 'Level 5: CHNBEAT',
    ...
    'ru': {
      ...
      'musicProducers': 'Музыкальные продюсеры:',
      'mainThemeCredit': 'Главная тема: YSN (tayson)',
      'levels123Credit': 'Уровни 1-3: YSN (tayson)',
      'level4Credit': 'Уровень 4: slumpy99',
      'level5Credit': 'Уровень 5: CHNBEAT',
